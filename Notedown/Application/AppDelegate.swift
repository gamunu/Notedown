...
let kNotedownErrorDomain = "com.gamunu.Notedown"
...
class AppDelegate: NSObject, NSApplicationDelegate
{
	...
	private func makeAboutWindow()
	{
		...
		aboutWindowController.appURL = URL(string: "https://www.fastcode.io/notedown")!
		aboutWindowController.appName = (bundle.object(forInfoDictionaryKey: "CFBundleName") as? String) ?? "Notedown"
		...
		let copyright = (bundle.object(forInfoDictionaryKey: "NSHumanReadableCopyright") as? String) ?? "Copyright © 2023 Gamunu Balagalla. All rights reserved."
