...
class Document: NSDocument
{
	...
	override func revert(toContentsOf url: URL, ofType typeName: String) throws
	{
		...
		{
			throw NSError(domain: kNotedownErrorDomain, code: 1020, userInfo: [NSLocalizedDescriptionKey: "Could not restore file"])
		}
	}
	...
	override func read(from url: URL, ofType typeName: String) throws
	{
		...
		{
			throw NSError(domain: kNotedownErrorDomain, code: 1010, userInfo: [NSLocalizedDescriptionKey: "Could not load file"])
		}
	}
	...
	override func printOperation(withSettings printSettings: [NSPrintInfo.AttributeKey: Any]) throws -> NSPrintOperation
	{
		...
		{
			throw NSError(domain: kNotedownErrorDomain,
						  code: 2001,
